...
public class Parallelinsertioninstudentfee {
	...
	public Parallelinsertioninstudentfee(int studentId, String admissionNumber, String studentName, long phoneNumber,
			String emailID, double totalFee, double paidFee, double remainingFee, String studentClass) {
		super();
		this.studentId = studentId;
		this.admissionNumber = admissionNumber;
		this.studentName = studentName;
