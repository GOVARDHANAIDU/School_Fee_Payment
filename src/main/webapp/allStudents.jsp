      ...
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">All Student Info</a></li>
            ...
            <%
                ...
                %>           
                    <tr>
                        ...
                        <th ><input value="<%= count%>" id="verysmall" name="prod_name" readonly="readonly"></th>
                        <th ><input value="<%= p.getAdmissionNumber() %>" id="small" name="prod_name" readonly="readonly"></th>
                        <th ><input value="<%= p.getStudentName() %>" id="small" name="prod_name" readonly="readonly"></th>
                        <td ><input value="<%= p.getPhoneNumber() %>"  id="small"  name="prod_price" readonly="readonly"></td>
                        <td ><input value="<%= p.getTotalFee() %>"  id="small" name="prod_brand"readonly="readonly"></td>
                        <td ><input value="<%= p.getPaidFee() %>"  name="prod_discount" id="small"readonly="readonly"></td>
                        <td ><input value="<%= p.getRemainingFee() %>"  name="prod_discount" id="medium"readonly="readonly"></td>
                        <td ><input value="<%= p.getStudentClass() %>"  name="prod_discount" id="verysmall"readonly="readonly"></td>
