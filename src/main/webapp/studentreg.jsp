...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4">
  <div class="container-fluid">
    ...
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-md shadow-md">
        ...
        <form action="studentregbackend.jsp" method="POST" class="space-y-6" id="registrationForm">
            <div class="form-row">
            ...
            <div class="form-row">
                ...
                <div class="placeholder-float">
                    <input type="number" id="totalFee" name="paidfee" placeholder=" " required class="placeholder-float__input">
                    <label for="totalFee" class="placeholder-float__label">Paid Fee <span class="text-red-500">*</span></label>
                </div>
